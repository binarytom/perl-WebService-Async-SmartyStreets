...
WebService::Async::SmartyStreets::International - calls the SmartyStreets International Street Address API and checks for the validity of the address
...
This module specifically accesses the International Street Address API
...
sub verify {
    my $self = shift;
    my $uri = 'https://international-street.api.smartystreets.com/verify';
    my %args = @_;
